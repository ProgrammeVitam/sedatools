...
class CompactorTest implements UseTestFiles {
    ...
    void TestCompactor() throws Exception {
        ...
        ArchiveUnit rootAu =
            di.getArchiveTransfer().getDataObjectPackage().getGhostRootAu().getChildrenAuList().getArchiveUnitList()
                .get(0);
        ...
        String packContent = "<Content>\n" +
            ...
            "          <LastModified>2020-06-05T14:00:12.540555</LastModified>\n" +
            "        </FileInfo>\n" +
            "      </FileObject>\n" +
            "      <SubDocument>\n" +
            "        <Content>\n" +
            ...
            "  </DocumentPack>\n" +
            "</Content>";
        assertThat(packAU.getContentXmlData()).isEqualTo(packContent);
